 ...
 70. ### How to add multiple middlewares to Redux?
  ...
  72. ### What is the difference between React and Angular?
        ...
        Let's see the difference between React and Angular in a table format.
         ...
         | In React, data flows only in one way and hence debugging is easy   | In Angular, data flows both way i.e it has two-way data binding    |
                                                                                 between children and parent and hence debugging is often difficult|
